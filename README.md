...
![](https://raw.githubusercontent.com/necusjz/p/master/splatbrush/mailbox.png)
...
4. Clone splatbrush and make a Vagrantfile:
    ```bash
   $ git clone https://github.com/necusjz/splatbrush.git
   $ cd splatbrush/vagrant
   $ ./make_vagrantfile.py
    ```
...
![](https://raw.githubusercontent.com/necusjz/p/master/splatbrush/dataset.png)
...
## License
This repository is licensed under MIT. Full license text is available in [LICENSE](https://github.com/necusjz/splatbrush/blob/main/LICENSE).
